// Two-stage build for the ScanVerse Setup .exe.
//   1. Build the main ScanVerse desktop app in --dir mode (no installer
...
//
// Output: dist/ScanVerse-Setup-X.Y.Z.exe (signed, branded, frameless UI)
//
...
(async () => {
  console.log('━━━ ScanVerse Setup builder ━━━');

  // 1) Build the main desktop app in --dir mode.
  console.log('\n[1/3] Build main ScanVerse app (--dir)…');
  await rmrf(APP_OUT);
